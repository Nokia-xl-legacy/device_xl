...
LOCAL_PATH := device/nokia/xl/

-include vendor/huawei/msm7x27a-common/BoardConfigVendor.mk

-include device/nokia/xl/kernel/Android.mk

TARGET_SPECIFIC_HEADER_PATH := device/nokia/xl/include
...
ARCH_ARM_HAVE_TLS_REGISTER := true
BOARD_EGL_CFG := device/nokia/xl/config/egl.cfg
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/nokia/xl/bluetooth

# Dalvik
TARGET_ARCH_LOWMEM := true

# Hardware tunables framework
BOARD_HARDWARE_CLASS := device/nokia/xl/cmhw/
...
BOARD_RIL_CLASS := ../../../device/nokia/xl/ril/
...
# Recovery # CWM
BOARD_CUSTOM_GRAPHICS := ../../../device/nokia/xl/recovery/graphics.c
TARGET_RECOVERY_FSTAB := device/nokia/xl/rootdir/recovery.fstab
DEVICE_RESOLUTION := 480x800 \
...
TARGET_RECOVERY_INITRC := device/nokia/xl/recovery/init.rc
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/nokia/xl/recovery/recovery-keys.c
